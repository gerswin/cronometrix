...
///   60 min extra a 1,5x         ->  938  (9.375 redondeado hacia arriba)
///   total                       -> 5938
...
fn overtime_is_paid_once_at_150_percent_not_250() {
    ...
    assert_eq!((work, ot, total), (5_000, 938, 5_938));
...
/// 450 x 5_000 / 480 = 4687.5 -> redondeo simétrico hacia arriba a 4688.
#[test]
